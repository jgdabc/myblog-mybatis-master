...
import com.jgdabc.dao.BlogDao;
import com.jgdabc.dao.CommentDao;
...
public class CommentServiceImpl implements CommentService {
    ...
    public int saveComment(Comment comment,Comment parentComment) {
        ...
        if(!StringUtils.isEmpty(parentComment)){
            ...
            String comtent = "亲爱的" + parentNickname + "，您在兰舟千帆博客的评论收到了来自" + nickName + "的回复！内容如下：" + "\r\n" + "\r\n" +  comment.getContent();
            ...
            {
                if (!StringUtils.isEmpty(parentComment.getEmail()))
                {
                    simpleMailMessage.setSubject(comment.getNickname()+"回复你了");  //主题
